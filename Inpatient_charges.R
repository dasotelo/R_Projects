...
ggplot(ipchrg_reg_maj1,aes(x=ipchrg_reg_maj1$Avg.Cov.Chrg)) +
  ...
  labs(x='Avg. Covered Charge Amount',y='Count of Hospitals',
    title='Kidney & UT Infections - No Complications') +
...
ggplot(ipchrg_reg_maj2,aes(x=ipchrg_reg_maj2$Avg.Cov.Chrg)) +
  ...
  labs(x='Avg. Covered Charge Amount',y='Count of Hospitals',
    title='Major Joint Replacement/Limb Reattachment - No Complications') +
